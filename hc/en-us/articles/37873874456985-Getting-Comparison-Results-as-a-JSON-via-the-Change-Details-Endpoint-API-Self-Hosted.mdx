---
title: "Getting Comparison Results as a JSON via the Change-Details Endpoint (API Self Hosted)"
...
<Note>
**Note**: The example URL above is provided for illustration purposes and will not work without valid credentials.
</Note>
