---
title: "Side-by-Side Document Compare Failure in Draftable Business"
...
<Step>
	This can be done in various ways, either by clicking **settings** in the new comparison window or right-clicking the taskbar icon and selecting **settings.** See the examples below.   
          ...
          <Frame>
		![](/images/draftable-business/image-19.png)  
          </Frame>
          <br/>
          <Frame>
		![](/images/draftable-business/image-20.png)  
          </Frame>
</Step>
<Step>
Go to the **Troubleshooting** tab.  
	...
	<Frame>
	![](/images/draftable-business/image-21.png)
	</Frame>
</Step>
<Step>
