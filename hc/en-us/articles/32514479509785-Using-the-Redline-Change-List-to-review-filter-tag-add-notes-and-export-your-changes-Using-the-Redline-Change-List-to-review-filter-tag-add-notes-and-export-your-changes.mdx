...
<Frame>![](/images/draftable-legal/image-287.png)</Frame>
...
Open the **New Comparison Window**, load your input files and run a comparison using the **Redline (.pdf) Comparison Type**   
	<Frame>![](/images/draftable-legal/image-288.png)</Frame>
</Step>
<Step>
Once you have run your compare, your Redline PDF will open in the **Draftable viewer**. The **Change List** will load on the **right hand side** of the screen by default.   
	<Frame>![](/images/draftable-legal/image-289.png)</Frame>
</Step>
<Step>
If you prefer to **see the changes on the left hand side** of the viewer, you can swap to this side by **clicking the icon** in the **bottom right corner** of the screen (pictured)  
	<Frame>![](/images/draftable-legal/image-290.png)</Frame>
	You can **minimize** **the Change List** by **clicking** on the Change List **icon (pictured)** in the top right corner of the Change List  
	<Frame>![](/images/draftable-legal/image-291.png)</Frame>
</Step>
</Steps>
## Navigating through the changes

1. You can easily review your changes by scrolling the change list, and can review them in your redline PDF by **clicking on the individual Change Card in the Change List.** This will scroll to the change and highlight it with a blue box around the relevant text.  
	<Frame>![](/images/draftable-legal/image-292.png)</Frame>
2. You can also navigate changes by using the **'next' and 'previous' change commands** in the ribbon menu. This will scroll to the change and highlight it with a blue box around the relevant text.  
	<Frame>![](/images/draftable-legal/image-293.png)</Frame>

## Filtering the change list
<Steps>
<Step>
You can filter which changes are listed by using the filter menu at the top of the change list.   
	<Frame>![](/images/draftable-legal/image-294.png)</Frame>
</Step>
<Step>
When filtering, you can choose to select what is shown or to select what should not be shown  
	<Frame>![](/images/draftable-legal/image-295.png)</Frame>
</Step>
<Step>
When selecting what is or is not shown, you have several options.  
	<Frame>![](/images/draftable-legal/image-296.png)</Frame>
	  
	You can filter changes based on the type of Change Type (i.e. insertions, deletions, moved text, etc)  
	<Frame>![](/images/draftable-legal/image-297.png)</Frame>
	  
	You can filter changes based on the type of Content Type (i.e. Text, Table of Contents, Image, etc)  
	<Frame>![](/images/draftable-legal/image-298.png)</Frame>
	  
	You can filter changes based on the Change Location (i.e. Main Document, Headers, Footers, etc)  
	<Frame>![](/images/draftable-legal/image-299.png)</Frame>
	  
	You can filter changes based on whether or not any notes have been added  
	<Frame>![](/images/draftable-legal/image-300.png)</Frame>
	  
	You can filter changes based on the status tags applied (e.g. High Priority, Action Required, etc)  
	<Frame>![](/images/draftable-legal/image-301.png)</Frame>
</Step>
<Step>
Once the change list is filtered, any content on the PDF that is 'filtered' will be greyed out. For example, below shows non filtered changes:  
	<Frame>![](/images/draftable-legal/image-302.png)</Frame>
	And below shows 'filtered' changes:
    <Frame>![](/images/draftable-legal/image-303.png)</Frame>
</Step>
</Steps>
...
<Frame>![](/images/draftable-legal/image-304.png)</Frame>
...
<Frame>![](/images/draftable-legal/image-308.png)</Frame>
...
First, navigate to the top left of the comparison window and select either the **Open** or **Save** output options.  
	<Frame>![](/images/draftable-legal/image-311.png)</Frame>
</Step>
<Step>
Once selected you will note the change pages option at the bottom of the export window.   
	<Frame>![](/images/draftable-legal/image-312.png)</Frame>
	...
	<Frame>![](/images/draftable-legal/image-313.png)</Frame>
	<Frame>![](/images/draftable-legal/image-314.png)</Frame>
...
<Frame>![](/images/draftable-legal/image-315.png)</Frame>
</Step>
</Steps>
