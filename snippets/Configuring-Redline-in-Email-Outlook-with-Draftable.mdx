...
<Warning>**Note:** Redline in Email is currently NOT supported for remote desktop, citrix or RDP environments.</Warning>
...
- You must have **at least Draftable v25.11.000** for this Add-in to correctly function.
...
<Step>
2. Download the **latest manifest file** by following the below URL:  
	  
	[https://dl.draftable.com/addins/outlook/1.1.28/manifest.xml](https://dl.draftable.com/addins/outlook/1.1.28/manifest.xml)  
	  
	<Note>**Note:** The Redline in Email Add-in **does not auto-update**. You will need to retrieve the latest manifest file when you wish to update your version of the Add-in.</Note>
</Step>
<Step>
This URL will always point to the latest version of the Draftable Outlook Add-in manifest.
</Step>
<Step>
 Click **Validate**.
	<Frame>
	![](/images/draftable-legal/image-211.png)
	</Frame>
</Step>
</Steps>
...
- Choose whether the add-in should be **automatically installed** or **available for users to install manually**.
	<Frame>
	![](/images/draftable-legal/image-212.png)
	</Frame>
...
<Frame>
![](/images/draftable-legal/image-213.png)
</Frame>
